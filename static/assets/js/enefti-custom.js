...
(function ($) {
  ...
  jQuery(document).ready(function () {
    ...
    function eneft_contact_response(responseText, statusText, xhr, $form) {
      if (responseText == 'success') {
        $('.enefti-submission-result').html(
          '<div class="alert alert-success" role="alert"><strong>Thank you!</strong> Your Message has been submitted!</div>'
        );
      } else {
        $('.enefti-submission-result').html(
          '<div class="alert alert-warning" role="alert"><strong>Error!</strong> There was a problem processing your submission. Try again later.</div>'
        );
      }
    }
  });
  ...
  jQuery(window).scroll(function () {
    jQuery(this).scrollTop() > offset
      ? $back_to_top.addClass('enefti-is-visible')
      : $back_to_top.removeClass('enefti-is-visible enefti-fade-out');
